...
blackboat = boat.items.create(name:"black boat", description:"this is a black boat", price: 7, contact:(6895605614))
whiteboat = boat.items.create(name:"white boat", description:"this is a white boat", price: 7, contact:(7087512531))
goldboat = boat.items.create(name:"gold boat", description:"this is a gold boat", price: 7, contact:(9817525878))
...
blueparaglider = submarine.items.create(name:"blue submarine", description:"this is a blue submarine", price: 7, contact:(8892145899))
greenparaglider = submarine.items.create(name:"green submarine", description:"this is a blue submarine", price: 7, contact:(6292951125))
purpleparaglider = submarine.items.create(name:"purple submarine", description:"this is a blue submarine", price: 7, contact:(9817525878))
redparaglider = submarine.items.create(name:"red submarine", description:"this is a blue submarine", price: 7, contact:(8693345879))
orangeparaglider = submarine.items.create(name:"orange submarine", description:"this is a blue submarine", price: 7, contact:(8012425634))
yellowparaglider = submarine.items.create(name:"yellow submarine", description:"this is a blue submarine", price: 7, contact:(443242349))
brownparaglider = submarine.items.create(name:"brown submarine", description:"this is a blue submarine", price: 7, contact:(7087512531))
blackparaglider = submarine.items.create(name:"black submarine", description:"this is a blue submarine", price: 7, contact:(233242349))
whiteparaglider = submarine.items.create(name:"white submarine", description:"this is a blue submarine", price: 7, contact:(3854413246))
goldparaglider = submarine.items.create(name:"gold submarine", description:"this is a blue submarine", price: 7, contact:(5708977489))